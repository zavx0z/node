...
const nodesStorybookRoot = fileURLToPath(new URL("../..", import.meta.url))
const layoutRoot = fileURLToPath(new URL("../../../layout", import.meta.url))
...
describe("dev-only nodes layout storybook", () => {
  test("belongs to the centralized parent storybook without a package-local server", async () => {
